...
@Configurable
public class AbstractEntityFormView extends VerticalLayout implements Button.ClickListener, FormFieldFactory {

	private static final long serialVersionUID = 1L;

	private BeanItem<AbstractEntityBean> mediaItem;
	...
	private MediaTableView view;
	private MovieEntryType entryType;

	@Autowired
	private MediaUiService mediaService;

	public AbstractEntityFormView(MediaTableView view) {
		this.view = view;
		createFormToolbar();
	...
	public void setMediaItem(Item selectedItem) {
		// initMovieHoldingEntry(selectedItem);
		holdingForm.setItemDataSource(selectedItem);
	...
	public BeanItem<AbstractEntityBean> getMediaItem() {
		return mediaItem;
	}
