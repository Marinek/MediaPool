//package de.mediapool.web.ui.widgets.ratingstars.gwt.client.ui;
//
...
//
//	public static final String STAR_CAPTION_ID = VRatingStars.STAR_CLASSNAME + "-caption";
//
...
//	}
//
//	public static void showAroundElement(Element target, String caption, String captionId) {
//		if (caption != null) {
//			Element starCaption = getStarCaption();
//
//			// set the text and display element (to get width for calculations)
//			starCaption.getElementsByTagName("span").getItem(0).setInnerText(caption);
...
//				starCaption.getStyle().setProperty("width", starCaption.getClientWidth() + "px");
//			}
//
//			// calculate position
...
//		return isVisible() && getStarCaption().getPropertyString("captionId").equals(captionId);
//	}
//
//	public static boolean isVisible() {
//		return !("none".equals(getStarCaption().getStyle().getProperty("display")));
//	}
//
