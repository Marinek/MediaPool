...
privileged aspect BoardgameForm_Roo_VaadinVisuallyComposableEntityForm {
    
    private Map<Object, Field> BoardgameForm.fieldMap = new LinkedHashMap<Object, Field>();
    
    private Map<Object, PropertyConverter> BoardgameForm.converterMap = new LinkedHashMap<Object, PropertyConverter>();
    
    public Collection<Object> BoardgameForm.getBeanPropertyIds() {
        return Arrays.asList(new Object[] { "title", "originaltitle", "launchyear", "cover", "price", "ean", "description", "special", "contenttype", "genre", "carrier", "mlanguage", "award", "participation", "duration", "playerfrom", "playerto", "approvedage", "extension" });
    }
    
    public Field BoardgameForm.getField(Object propertyId) {
        return fieldMap.get(propertyId);
    }
    
    public void BoardgameForm.configure() {
        configureFieldMap();
        configureFields();
    ...
    public void BoardgameForm.refresh() {
        configureContainersForFields();
        configureConverters();
        configureValidators();
    }
    
    public boolean BoardgameForm.isModified() {
    ...
    public void BoardgameForm.configureFieldMap() {
        ...
        fieldMap.put("playerfrom", playerfromField);
        fieldMap.put("playerto", playertoField);
        fieldMap.put("approvedage", approvedageField);
        fieldMap.put("extension", extensionField);
    }
    
    public void BoardgameForm.configureFields() {
    ...
    public void BoardgameForm.configureContainersForFields() {
        Field field;
    ...
    public void BoardgameForm.configureConverters() {
    ...
    public void BoardgameForm.configureValidators() {
        for (Object propertyId : getBeanPropertyIds()) {
            Field field = getField(propertyId);
            if (field != null) {
    ...
    public PropertyConverter BoardgameForm.getConverter(Object propertyId) {
        return converterMap.get(propertyId);
    }
    
    public BeanContainer<Long, MLanguage> BoardgameForm.getContainerForMLanguages() {
    ...
    public BeanContainer<Long, Award> BoardgameForm.getContainerForAwards() {
    ...
    public BeanContainer<Long, Participation> BoardgameForm.getContainerForParticipations() {
    ...
    public Object BoardgameForm.getMLanguageCaptionPropertyId() {
        return null;
    }
    
    public Object BoardgameForm.getAwardCaptionPropertyId() {
        return null;
    }
    
    public Object BoardgameForm.getParticipationCaptionPropertyId() {
        return null;
    }
    
    public String BoardgameForm.getIdProperty() {
        return "id";
    }
    
    public String BoardgameForm.getVersionProperty() {
        return "version";
    }
    
    public void BoardgameForm.validateFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
    ...
    public void BoardgameForm.commitFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
                if (field != null && !field.isReadOnly()) {
    ...
    public void BoardgameForm.setFieldPropertyDataSource(Object propertyId, Property property) {
        Field field = getField(propertyId);
        if (field == null) {
            return;
        }
    ...
    public void BoardgameForm.setFieldValues(Item item) {
        if (item != null) {
    ...
    public Field BoardgameForm.getFirstField() {
    ...
    public Class<Boardgame> BoardgameForm.getEntityClass() {
