 ...
 */
public class BookForm extends CustomComponent implements EntityEditor {
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        pagesField.setWidth("-1px");
        pagesField.setHeight("-1px");
        pagesField.setCaption("Pages");
        pagesField.setImmediate(true);
        fieldLayout.addComponent(pagesField);

        // isbnField
        isbnField = new TextField();
        isbnField.setWidth("-1px");
        isbnField.setHeight("-1px");
        isbnField.setCaption("Isbn");
        isbnField.setImmediate(true);
        fieldLayout.addComponent(isbnField);
