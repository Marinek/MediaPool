 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = entity.select.MLanguage.class)
public class MLanguageForm extends CustomComponent implements EntityEditor {
