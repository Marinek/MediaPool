 ...
 * @author Marcinek
 *
 * @param <T> Irgentwas, was einem {@link IPSValueObject} entspricht
 */
public interface IPSDataAccessObject<T extends IPSValueObject> {
	 ...
	 * 
	 * @param valueObject	Das Objekt, dass gespeichert werden sollen.
	 * @param psTransaction	Eine {@link IPSTransaction}
	 * @throws PSException  Wirft eine Exception, falls ein SQL Fehler auftritt.
	 */
	public  void saveOrUpdate(T valueObject, IPSTransaction psTransaction) throws PSException;
	
	/**
	 * Im prinzip genau wie {@link IPSDataAccessObject#saveOrUpdate(IPSValueObject, IPSTransaction)}, aber erstellt seine
	 * eigene Transaktion. Diese Aktion ist atomar und kann nicht zurückgerollt werden.
	 * 
	 * @param valueObject	Das Objekt, dass gespeichert werden sollen.
	 * @throws PSException  Wirft eine Exception, falls ein SQL Fehler auftritt.
	 */
	 ...
	 * @param valueObject	Das Objekt, das gelöscht werden soll.
	 * @param psTransaction Eine {@link IPSTransaction}
	 * @throws PSException  Wirft eine Exception, falls ein SQL Fehler auftritt.
	 */
	...
	/**
	 * Im prinzip genau wie {@link IPSDataAccessObject#delete(IPSValueObject, IPSTransaction)}, aber erstellt seine
	 * eigene Transaktion. Diese Aktion ist atomar und kann nicht zurückgerollt werden.
	 * 
	 * @param valueObject	Das Objekt, das gelöscht werden soll.
	 * @throws PSException Wirft eine Exception, falls ein SQL Fehler auftritt.
