 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = de.mediapool.grab.domain.Person.class)
public class PersonForm extends CustomComponent implements EntityEditor {
