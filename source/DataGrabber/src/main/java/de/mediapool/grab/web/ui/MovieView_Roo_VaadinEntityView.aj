...
privileged aspect MovieView_Roo_VaadinEntityView {
    ...
    public void MovieView.setupGeneratedColumns(Table table) {
        table.removeGeneratedColumn("cooperation");
        table.addGeneratedColumn("cooperation", new EntityTableColumnGenerator((String) getCooperationCaptionPropertyId()));
    }
    
    public Object MovieView.getCooperationCaptionPropertyId() {
        return null;
    }
