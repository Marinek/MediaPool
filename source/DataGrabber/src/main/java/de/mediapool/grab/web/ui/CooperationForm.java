 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = de.mediapool.grab.domain.Cooperation.class)
public class CooperationForm extends CustomComponent implements EntityEditor {
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        partField.setWidth("-1px");
        partField.setHeight("-1px");
        partField.setCaption("Part");
        partField.setImmediate(true);
        fieldLayout.addComponent(partField);

        // personField
        personField = new ComboBox();
        personField.setWidth("-1px");
        personField.setHeight("-1px");
        personField.setCaption("Person");
        personField.setImmediate(true);
        fieldLayout.addComponent(personField);
