 ...
 */
public class MusicForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TwinColSelect tracksField;
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // tracksField
        tracksField = new TwinColSelect();
        tracksField.setWidth("-1px");
        tracksField.setHeight("-1px");
        tracksField.setCaption("Tracks");
        tracksField.setImmediate(true);
        fieldLayout.addComponent(tracksField);
	...
	public BeanContainer<Long, Track> getContainerForTracks() {
