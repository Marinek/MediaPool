...
public interface IRelationshipDAO extends IPSDataAccessObject<RelationshipVO> {
	...
	public List<RelationshipVO> findParents (Integer pRelationTypeId, String pChildId, String pChildTypeId) throws PSException;

	public List<RelationshipVO> findChilds (Integer pRelationTypeId, String pParentId, String pParentTypeId) throws PSException;
