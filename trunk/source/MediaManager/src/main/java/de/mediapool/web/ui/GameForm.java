 ...
 */
public class GameForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TextField modusField;
    @AutoGenerated
    private TextField requirementField;
    @AutoGenerated
    private CheckBox euipmentneededField;
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // modusField
        modusField = new TextField();
        modusField.setWidth("-1px");
        modusField.setHeight("-1px");
        modusField.setCaption("Modus");
        modusField.setImmediate(true);
        fieldLayout.addComponent(modusField);

        // requirementField
        requirementField = new TextField();
        requirementField.setWidth("-1px");
        requirementField.setHeight("-1px");
        requirementField.setCaption("Requirement");
        requirementField.setImmediate(true);
        fieldLayout.addComponent(requirementField);

        // euipmentneededField
        euipmentneededField = new CheckBox();
        euipmentneededField.setWidth("-1px");
        euipmentneededField.setHeight("-1px");
        euipmentneededField.setCaption("Euipmentneeded");
        euipmentneededField.setImmediate(true);
        fieldLayout.addComponent(euipmentneededField);
