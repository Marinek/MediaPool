 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = entity.select.Contenttype.class)
public class ContenttypeForm extends CustomComponent implements EntityEditor {
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // mptypeField
        mptypeField = new TextField();
        mptypeField.setWidth("-1px");
        mptypeField.setHeight("-1px");
        mptypeField.setCaption("Mptype");
        mptypeField.setImmediate(true);
        fieldLayout.addComponent(mptypeField);
