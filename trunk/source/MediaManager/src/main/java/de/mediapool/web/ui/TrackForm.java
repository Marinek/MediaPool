 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = entity.meta.Track.class)
public class TrackForm extends CustomComponent implements EntityEditor {
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // tnumberField
        tnumberField = new TextField();
        tnumberField.setWidth("-1px");
        tnumberField.setHeight("-1px");
        tnumberField.setCaption("Tnumber");
        tnumberField.setImmediate(true);
        fieldLayout.addComponent(tnumberField);
