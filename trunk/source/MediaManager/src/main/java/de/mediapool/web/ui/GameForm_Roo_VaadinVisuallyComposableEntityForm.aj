...
privileged aspect GameForm_Roo_VaadinVisuallyComposableEntityForm {
    
    private Map<Object, Field> GameForm.fieldMap = new LinkedHashMap<Object, Field>();
    
    private Map<Object, PropertyConverter> GameForm.converterMap = new LinkedHashMap<Object, PropertyConverter>();
    
    public Collection<Object> GameForm.getBeanPropertyIds() {
        return Arrays.asList(new Object[] { "title", "originaltitle", "launchyear", "cover", "price", "ean", "description", "special", "contenttype", "genre", "carrier", "mlanguage", "award", "participation", "extension", "playerto", "approvedage", "modus", "requirement", "euipmentneeded" });
    }
    
    public Field GameForm.getField(Object propertyId) {
        return fieldMap.get(propertyId);
    }
    
    public void GameForm.configure() {
        configureFieldMap();
        configureFields();
    ...
    public void GameForm.refresh() {
        configureContainersForFields();
        configureConverters();
        configureValidators();
    }
    
    public boolean GameForm.isModified() {
    ...
    public void GameForm.configureFieldMap() {
        ...
        fieldMap.put("modus", modusField);
        fieldMap.put("requirement", requirementField);
        fieldMap.put("euipmentneeded", euipmentneededField);
    }
    
    public void GameForm.configureFields() {
    ...
    public void GameForm.configureContainersForFields() {
        Field field;
    ...
    public void GameForm.configureConverters() {
    ...
    public void GameForm.configureValidators() {
        for (Object propertyId : getBeanPropertyIds()) {
            Field field = getField(propertyId);
            if (field != null) {
    ...
    public PropertyConverter GameForm.getConverter(Object propertyId) {
        return converterMap.get(propertyId);
    }
    
    public BeanContainer<Long, MLanguage> GameForm.getContainerForMLanguages() {
    ...
    public BeanContainer<Long, Award> GameForm.getContainerForAwards() {
    ...
    public BeanContainer<Long, Participation> GameForm.getContainerForParticipations() {
    ...
    public Object GameForm.getMLanguageCaptionPropertyId() {
        return null;
    }
    
    public Object GameForm.getAwardCaptionPropertyId() {
        return null;
    }
    
    public Object GameForm.getParticipationCaptionPropertyId() {
        return null;
    }
    ...
    public void GameForm.validateFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
    ...
    public void GameForm.commitFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
                if (field != null && !field.isReadOnly()) {
    ...
    public void GameForm.setFieldPropertyDataSource(Object propertyId, Property property) {
        Field field = getField(propertyId);
        if (field == null) {
            return;
        }
    ...
    public void GameForm.setFieldValues(Item item) {
        if (item != null) {
    ...
    public Field GameForm.getFirstField() {
