 ...
 */
public class AwardForm extends CustomComponent implements EntityEditor {
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // ayearField
        ayearField = new TextField();
        ayearField.setWidth("-1px");
        ayearField.setHeight("-1px");
        ayearField.setCaption("Ayear");
        ayearField.setImmediate(true);
        fieldLayout.addComponent(ayearField);

        // categoryField
        categoryField = new TextField();
        categoryField.setWidth("-1px");
        categoryField.setHeight("-1px");
        categoryField.setCaption("Category");
        categoryField.setImmediate(true);
        fieldLayout.addComponent(categoryField);
