...
privileged aspect MediaForm_Roo_VaadinVisuallyComposableEntityForm {
    
    private Map<Object, Field> MediaForm.fieldMap = new LinkedHashMap<Object, Field>();
    
    private Map<Object, PropertyConverter> MediaForm.converterMap = new LinkedHashMap<Object, PropertyConverter>();
    
    public Collection<Object> MediaForm.getBeanPropertyIds() {
        return Arrays.asList(new Object[] { "title", "originaltitle", "launchyear", "cover", "price", "ean", "description", "special", "contenttype", "genre", "carrier", "mlanguage", "award", "participation" });
    }
    
    public Field MediaForm.getField(Object propertyId) {
        return fieldMap.get(propertyId);
    }
    
    public void MediaForm.configure() {
        configureFieldMap();
        configureFields();
    ...
    public void MediaForm.refresh() {
        configureContainersForFields();
        configureConverters();
        configureValidators();
    }
    
    public boolean MediaForm.isModified() {
    ...
    public void MediaForm.configureFieldMap() {
    ...
    public void MediaForm.configureFields() {
    ...
    public void MediaForm.configureContainersForFields() {
        Field field;
    ...
    public void MediaForm.configureConverters() {
    ...
    public void MediaForm.configureValidators() {
        for (Object propertyId : getBeanPropertyIds()) {
            Field field = getField(propertyId);
            if (field != null) {
    ...
    public PropertyConverter MediaForm.getConverter(Object propertyId) {
        return converterMap.get(propertyId);
    }
    
    public BeanContainer<Long, MLanguage> MediaForm.getContainerForMLanguages() {
    ...
    public BeanContainer<Long, Award> MediaForm.getContainerForAwards() {
    ...
    public BeanContainer<Long, Participation> MediaForm.getContainerForParticipations() {
    ...
    public Object MediaForm.getMLanguageCaptionPropertyId() {
        return null;
    }
    
    public Object MediaForm.getAwardCaptionPropertyId() {
        return null;
    }
    
    public Object MediaForm.getParticipationCaptionPropertyId() {
        return null;
    }
    
    public String MediaForm.getIdProperty() {
        return "id";
    }
    
    public String MediaForm.getVersionProperty() {
        return "version";
    }
    
    public void MediaForm.validateFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
    ...
    public void MediaForm.commitFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
                if (field != null && !field.isReadOnly()) {
    ...
    public void MediaForm.setFieldPropertyDataSource(Object propertyId, Property property) {
        Field field = getField(propertyId);
        if (field == null) {
            return;
        }
    ...
    public void MediaForm.setFieldValues(Item item) {
        if (item != null) {
    ...
    public Field MediaForm.getFirstField() {
    ...
    public Class<Media> MediaForm.getEntityClass() {
        return Media.class;
    }
