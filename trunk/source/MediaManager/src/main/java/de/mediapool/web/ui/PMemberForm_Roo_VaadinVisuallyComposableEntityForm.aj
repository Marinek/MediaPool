...
privileged aspect PMemberForm_Roo_VaadinVisuallyComposableEntityForm {
    
    private Map<Object, Field> PMemberForm.fieldMap = new LinkedHashMap<Object, Field>();
    
    private Map<Object, PropertyConverter> PMemberForm.converterMap = new LinkedHashMap<Object, PropertyConverter>();
    
    public Collection<Object> PMemberForm.getBeanPropertyIds() {
        return Arrays.asList(new Object[] { "firstname", "name", "type" });
    }
    
    public Field PMemberForm.getField(Object propertyId) {
        return fieldMap.get(propertyId);
    }
    
    public void PMemberForm.configure() {
        configureFieldMap();
        configureFields();
    ...
    public void PMemberForm.refresh() {
        configureContainersForFields();
        configureConverters();
        configureValidators();
    }
    
    public boolean PMemberForm.isModified() {
    ...
    public void PMemberForm.configureContainersForFields() {
        // no fields require special containers
    }
    
    public void PMemberForm.configureConverters() {
        // no converters needed
    }
    
    public void PMemberForm.configureValidators() {
        for (Object propertyId : getBeanPropertyIds()) {
            Field field = getField(propertyId);
            if (field != null) {
    ...
    public PropertyConverter PMemberForm.getConverter(Object propertyId) {
        return converterMap.get(propertyId);
    }
    
    public String PMemberForm.getIdProperty() {
        return "id";
    }
    
    public String PMemberForm.getVersionProperty() {
        return "version";
    }
    
    public void PMemberForm.validateFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
    ...
    public void PMemberForm.commitFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
                if (field != null && !field.isReadOnly()) {
    ...
    public void PMemberForm.setFieldPropertyDataSource(Object propertyId, Property property) {
        Field field = getField(propertyId);
        if (field == null) {
            return;
        }
    ...
    public void PMemberForm.setFieldValues(Item item) {
        if (item != null) {
    ...
    public Field PMemberForm.getFirstField() {
    ...
    public Class<PMember> PMemberForm.getEntityClass() {
